...
　// ---SP用メニューボタン
  ...
  // ---カレンダー（１０月）
  let year = Number(document.querySelector('.oct-year-month').getAttribute('data-year'));
  let month = Number(document.querySelector('.oct-year-month').getAttribute('data-month'));
  let dayoff = [
